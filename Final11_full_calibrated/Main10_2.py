...
# ====================
RESULT_PATH = 'results_Final10_2'

# SMPLX model paths
SMPLX_MODEL_PATHS = {
    'male': 'F:/code/Final-project_radar_navigation/SMPLX1/SMPLX_MALE.npz',
    'female': 'F:/code/Final-project_radar_navigation/SMPLX1/SMPLX_FEMALE.npz',
    'neutral': 'F:/code/Final-project_radar_navigation/SMPLX1/SMPLX_NEUTRAL.npz'
}
...
SPACE = [
    ...
    Real(2.0, 10.0, name='betas_weight'),        # 最小为 1.0
    ...
    Real(0.001, 10.0, name='vertices_weight'),     # 最小为 1.0
...
class FPN3DWithAttention(nn.Module):
    def __init__(self, in_channels_list, out_channels):
        super(FPN3DWithAttention, self).__init__()
        ...
        for in_channels in in_channels_list:
            ...
            attention_module = AttentionModule(out_channels)
...
class Simple3DConvModelWithTripleCNNFPNAndAttention(nn.Module):
    def __init__(self, smplx_model_paths, input_channels=31, fpn_out_channels=256, reduced_channels=128, dropout_rate=0.2):
        ...
        self.fpn = FPN3DWithAttention([64, 128, 256], fpn_out_channels)
